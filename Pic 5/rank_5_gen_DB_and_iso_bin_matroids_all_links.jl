...
# open("rank_5_mat_DB_bin.jls", "w") do io
...
simple_bin_matroids_bin = open("rank_5_mat_DB_bin.jls", "r") do io
    deserialize(io)
end

iso_DB = Dict{Int,Dict{Int,Vector{Tuple{Int,Any}}}}()

build_iso_db!(iso_DB,simple_bin_matroids_bin,ms=7:11,verbose=true)


open("rank_5_iso_DB_bin_all_v.jls", "w") do io
    serialize(io, iso_DB)
end
